		...
		<nav class="navbar navbar-fixed-top navbar--color--ghost navbar--size--xl" data-startColor="navbar--color--ghost" data-startSize="navbar--size--xl" data-intoColor="navbar--color--secondary" data-intoSize="navbar--size--md">
		  <div class="container">
		    <div class="navbar-header">
		      <button class="navbar-toggle collapsed" type="button" data-toggle="collapse" data-target="#mobileNav" aria-expanded="false">
					  ...
					  <div class="form-group form-group-sm">
					    ...
					    <div style="margin-left: 15px" class="col-sm-11">
					      <div class="radio col-sm-6">
								...
								<div class="radio col-sm-6">
								  <label>
								    <input class="lainnya-user" type="radio" name="proposal" value="other">
								    Other...
								  </label>
								</div>
								<div class="radio other col-sm-6 hide relative">
							    <input class="other10 form-control" type="text" name="other" placeholder="Lainnya...">
								</div>
					    </div>
					  </div>
					  <div class="submit-btn">
					  	<button id="submit-user" type="submit" class="btn">Download</button>
					  </div>
					</form>
				</div>
			</div>
